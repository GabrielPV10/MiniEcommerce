@php $esCliente = auth()->user()->rol === 'cliente'; @endphp
...
<style>
    ...
    .gallery-placeholder {
        ...
        align-items:center; gap:.75rem; color:#cbd5e0;
    }
        ...
        <div class="info-panel">
            ...
            <div class="info-cats">
                @foreach($producto->categorias as $cat)
                    <a href="{{ route('dashboard.cliente', ['categoria' => $cat->id]) }}" class="info-cat">{{ $cat->nombre }}</a>
                @endforeach
            </div>
            ...
            @else
                <span class="stock-badge-no">Agotado por el momento</span>
            @endif
            ...
            <a href="{{ route('dashboard.cliente') }}" class="btn-back">
                ← Seguir comprando
            </a>
